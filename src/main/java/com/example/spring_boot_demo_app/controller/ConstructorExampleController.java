...
//        employee5= new Employee(5,"XYZ");
    ...
    @PostMapping("/constructor/outsideEmployee")
    public Employee getEmployeeByConsturctorOverLoading(@RequestBody Employee outsideEmployee) {

        Employee employee;

        if (outsideEmployee.getId() != 0 && outsideEmployee.getName() != null && outsideEmployee.getLastName() != null) {
            employee = new Employee(2, "aman", "maharjan");
        } else if (outsideEmployee.getId() != 0 && outsideEmployee.getName() != null) {
            employee = new Employee(1, "Arjun");
        } else if (outsideEmployee.getId() != 0) {
